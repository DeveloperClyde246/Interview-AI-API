...
# Adjust path to locate tone_analysis_dashboard
...
if uploaded_file is not None:
    ...
    with st.spinner('Processing...'):
        ...
        personality_scaler = joblib.load('tone_analysis_dashboard/personality_model2/personality_feature_scaler.joblib')
